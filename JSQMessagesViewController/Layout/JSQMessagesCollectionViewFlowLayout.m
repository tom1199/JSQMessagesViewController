...
- (void)prepareLayout
{
    ...
    if (self.springinessEnabled) {
        ...
        //Fix issue: https://github.com/jessesquires/JSQMessagesViewController/issues/1868
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    [attributesInRect enumerateObjectsUsingBlock:^(JSQMessagesCollectionViewLayoutAttributes *attributesItem, NSUInteger idx, BOOL *stop) {
        ...
        // Fix issue: https://github.com/jessesquires/JSQMessagesViewController/issues/1424
        // else {
