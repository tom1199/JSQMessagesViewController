...
- (void)jsq_configureCollectionView
{
    ...
    [self registerNib:[JSQMessagesEditCollectionOverlayView nib]forSupplementaryViewOfKind:kJSQCollectionElementKindEditOverlay withReuseIdentifier:[JSQMessagesEditCollectionOverlayView editingReuseIdentifier]];
